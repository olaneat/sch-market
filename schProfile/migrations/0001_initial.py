        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('school_badge', models.ImageField(
                    blank=True, null=True, upload_to='assets/badge')),
                ('school_type', models.CharField(choices=[
                 ('Boarding', 'Boarding'), ('Day', 'Day'), ('Both', 'Both')], max_length=50)),
                ('school_gender', models.CharField(choices=[
                 ('Male', 'Male'), ('Female', 'Female'), ('Mixed', 'Mixed')], max_length=20)),
                ('school_level', models.CharField(choices=[
                 ('Primary', 'Primary'), ('Secondary', 'Secondary'), ('Both', 'Both')], max_length=40)),
