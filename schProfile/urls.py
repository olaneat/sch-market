...
from .apiviews import CreateProfileView, UpdateSchoolProfile, DeleteSchoolProfile, DispaySchoolDetail, DisplaySchoolList, school_detail
...
urlpatterns = [
    ...
    path('detail-page/<int:id>', apiviews.school_detail, name='detail'),
